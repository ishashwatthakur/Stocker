document.addEventListener('DOMContentLoaded', () => {
  ...
  elements.togglePortfolio.textContent = 
    ...
    const setupEventListeners = () => {
        ...
        elements.chartTypeSelect.addEventListener('change', () => {
            elements.togglePortfolio.addEventListener('click', togglePortfolio);
  ...
  try {
    ...
    const loadPortfolio = () => {
        const savedPortfolio = localStorage.getItem('stockerPortfolio');
        if (savedPortfolio) {
    ...
    const saveAndReloadPortfolio = () => {
        ...
        localStorage.setItem('stockerPortfolio', JSON.stringify(state.portfolio));
        renderPortfolio();
        updatePortfolioValues();
